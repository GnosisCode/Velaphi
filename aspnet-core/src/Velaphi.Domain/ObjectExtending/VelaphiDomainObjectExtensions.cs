...
namespace Velaphi.ObjectExtending
{
    public static class VelaphiDomainObjectExtensions
    {
        ...
        public static void Configure()
        {
            OneTimeRunner.Run(() =>
            {
                 ...
                 * table fields in the database, then configure them in the VelaphiEfCoreEntityExtensionMappings
                 *
                 * Example:
                 *
