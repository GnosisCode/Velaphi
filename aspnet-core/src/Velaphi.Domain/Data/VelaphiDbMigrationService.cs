...
{
    public class VelaphiDbMigrationService : ITransientDependency
    {
        public ILogger<VelaphiDbMigrationService> Logger { get; set; }

        private readonly IDataSeeder _dataSeeder;
        private readonly IEnumerable<IVelaphiDbSchemaMigrator> _dbSchemaMigrators;
        private readonly ITenantRepository _tenantRepository;
        private readonly ICurrentTenant _currentTenant;

        public VelaphiDbMigrationService(
            IDataSeeder dataSeeder,
            IEnumerable<IVelaphiDbSchemaMigrator> dbSchemaMigrators,
            ...
            ICurrentTenant currentTenant)
        {
            ...
            Logger = NullLogger<VelaphiDbMigrationService>.Instance;
        }
